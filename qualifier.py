...
- Пиши коротко: 1–3 предложения, на «вы», без markdown и без эмодзи.
...
Отвечай на вопросы клиента коротко (1–3 предложения), на «вы», без markdown и без эмодзи, строго по базе знаний. Чего нет в базе — скажи, что уточнит менеджер. Никогда не выдумывай.
...
TEMPERATURES = {"hot": "Горячий", "warm": "Тёплый", "cold": "Холодный"}
